...
public class Day9Input2 {


    public static void main(String[] args) throws FileNotFoundException {

        Scanner scanner = new Scanner(new File("day9/input2.txt"));
    ...
    private static long calculateTotal(List<int[]> listOfInts) {
        long extrapolatedValue = 0;
         for(int i= listOfInts.size()-1; i >= 0; i--){
             ...
             extrapolatedValue =   current[0] - extrapolatedValue;
              System.out.println(" current: " + current[0] + " extrapolatedValue: " + extrapolatedValue );
         }
